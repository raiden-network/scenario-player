...
from .constants import (
    RELEASE_NO_ARCHIVE_NO_BIN,
    RELEASE_WITH_ARCHIVE_AND_BIN,
)
...
@mock.patch('scenario_player.services.releases.blueprints.binaries.JSONRedis', return_value=TestRedis('binaries'))
