...
class TestNewTransactionEndpoint:
    ...
    @patch('scenario_player.services.transactions.blueprints.transactions.TransactionSendSchema', autospec=True)
    def test_new_transaction_calls_load_of_its_validator_schema(
            self, mock_validator, transaction_service_client
    ):
        """The :meth:`scenario_player.services.transactions.blueprints.TransactionSendSchema.validate_and_deserialize`
    ...
    def test_new_transaction_calls_dump_of_its_serializer_schema(self, mock_serializer, transaction_service_client):
        """The :meth:`scenario_player.services.transactions.blueprints.TransactionSendSchema.dump`
    ...
    def test_new_transaction_calls_the_services_jsonrpc_client_with_the_requests_params(
        ...
        and its result passed to :meth:`scenario_player.services.transactions.blueprints.TransactionSendSchema.dump`.
        """
        parameters = {"value": 123, "to_address": 'someaddress', "startgas": 2}
