...
from scenario_player.services.scenario.blueprints import scenario_view
from scenario_player.services.releases.blueprints import binaries_views, archives_views, releases_views
